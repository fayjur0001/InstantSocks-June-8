// PATH: client/src/components/admin/headerNav/NotificationDropdown.tsx
"use client";
      ...
      <PopoverTrigger asChild>
        <button className="relative cursor-pointer p-1.5 rounded-[6px] border border-white/10 bg-white/5 hover:bg-white/20 hover:border-white/30 transition duration-200 outline-none">
          ...
          {notificationsCount > 0 && (
            <span className="absolute top-1.5 right-1.5 block w-1.5 h-1.5 rounded-full bg-c-red-500 ring-1 ring-c-bg-750" />
          )}
        </button>
      </PopoverTrigger>
